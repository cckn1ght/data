...
class feature_extractor(object):
    ...
    def extract(self):
        ...
        feature_writer.writerow(['screen_name', 'uppper_letter_count',
                                 'followers_count',
        ...
        with open(self.csv_name, 'r', encoding='utf-8', errors='ignore') as annotated_file:
            ...
            for line in annotated_reader:
                ...
                screen_name = line[1]
                uppper_letter_count = sum(1 for c in scrren_name if c.is_upper())
                ...
                class_type = line[0]
                the_vector = []
                the_vector = [screen_name, uppper_letter_count,
